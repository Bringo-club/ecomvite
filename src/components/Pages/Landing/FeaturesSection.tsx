...
const FeaturesSection: React.FC = () => {
	...
	return (
		<div className="container py-20">
			<h2 className="text-center text-4xl font-bold text-dark-green">{t("featuresSection.header")}</h2>
...
const FeatureItem: React.FC<{ feature: IFeature }> = ({ feature }) => {
	...
	return (
		<div className="basis-1/2 flex items-center justify-end mb-8 gap-4">
